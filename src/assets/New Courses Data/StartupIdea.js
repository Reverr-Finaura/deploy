const data = [
  {
    id: 1,
    courseName: "THINKING OF A STARTUP IDEA",
    type: "course",
    image:
    ...
    module: [
      {
        id: 1,
        name: "HOW TO GENERATE STARTUP IDEAS",
        title: "Module-1",
        image:
        ...
        slides: [
          ...
          },
          {
            ...
            title: "",
            detail: [
              "if you are making plans to begin your adventure in the destiny, turning into an expert in something worthwhile could be very beneficial, and perhaps your high-quality bet is to get a job at the vanguard of a particular area. if you're at the leading edge of any area or area, you may see a good start before absolutely everyone else.",
            ],
            img: "",
          },
          {
            id: 7,
            type: "question",
            question: "What type of idea is best for a startup?",
            options: [
              "A startup concept that emerges organically. ",
              "A startup idea your friends suggest.",
              "A startup idea that was successful in another country. ",
              "A startup idea in high-growth sectors.",
            ],
            title: "Quiz Time!!",
            answer: "1",
            img: "",
          },
          {
            id: 8,
            type: "question",
            question: "You can organically generate startup ideas by……",
            options: [
              "Becoming an expert in a field and be at its vanguard to generate ideas before others ",
              "Stealing ideas and making little changes.",
              "hiring ex-startup founders.",
              "having the best possible founding team.",
            ],
            title: "Quiz Time!!",
            answer: "1",
            img: "",
          ...
          },
          {
            ...
            type: "question",
            question:
              "You can generate a startup idea by“Seeking new alternative by finding recently successful companies”",
            options: ["True", "False"],
            title: "Quiz Time!!",
            answer: "1",
            img: "",
      ...
      {
        id: 2,
        name: "HOW TO EVALUATE A STARTUP IDEA",
        title: "Module-2",
        image:
        ...
        slides: [
          ...
          },
          {
            ...
            type: "question",
            question:
              "Ideally, you should  have _______ the  problem you are solving.",
            options: [
          ...
          },
          {
            id: 13,
            type: "question",
            question: "Most dangerous part of filters is…….",
            options: [
              "that they will cause you to reject your best startup ideas unconsciously ",
              "that they will cause you to accept your best startup ideas unconsciously",
              "that they will cause you to select your best startup ideas unconsciously",
            ],
            title: "Quiz Time!!",
            answer: "1",
            img: "",
      ...
      },
      {
        ...
        slides: [
          ...
          },
          {
            id: 9,
            type: "question",
            question: "which is a better method to look for startup ideas ?",
            options: [
              "start with the problem and then find a solution",
              "start with the solution and then evaluate the problem it is solving. ",
            ],
            title: "Quiz Time!!",
            answer: "1",
            img: "",
          },
          {
            id: 10,
            type: "question",
            question: "what is SISP?",
            options: [
              "Searching in Solved Problems",
              "Solving in Search of Problem ",
              "Solving initially solvable Problems. ",
            ],
            title: "Quiz Time!!",
            answer: "2",
            img: "",
