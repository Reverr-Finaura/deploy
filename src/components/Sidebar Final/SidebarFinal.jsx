  ...
  return (
    ...
    <section id='sidebar-final'>
      ...
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={theme==="light-theme"?dashD:dashL} alt="icon" />
        <p className='sidebar-final-icon-name'>Dashboard</p>
      </div>
      </NavLink>
<NavLink style={{textDecoration:"none"}} to="/knowledge">
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={theme==="light-theme"?knowD:knowL} alt="icon" />
...
<NavLink style={{textDecoration:"none"}} to="/funding-page" >
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon sidebar-final-funding-icon' src={theme==="light-theme"?fundD:fundL} alt="icon" />
        <p className='sidebar-final-icon-name'>Funding</p>
      </div>
</NavLink>
<NavLink style={{textDecoration:"none"}} to="/mentors">
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon sidebar-final-mentor-icon' src={theme==="light-theme"?mentD:mentL} alt="icon" />
        <p className='sidebar-final-icon-name'>Mentorship</p>
      </div>
</NavLink>
<NavLink style={{textDecoration:"none"}} to="/community">
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={theme==="light-theme"?comD:comL} alt="icon" />
