  ...
  return (
    ...
    <section id='sidebar-final'>
      ...
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={dashboardIcon} alt="icon" />
        <p className='sidebar-final-icon-name'>Dashboard</p>
      </div>
      </NavLink>
<NavLink style={{textDecoration:"none"}} to="/knowledge">
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={knowledgeIcon} alt="icon" />
...
<NavLink style={{textDecoration:"none"}} to="/community">
      <div className='sidebar-final-icon-name-cont'>
        <img className='sidebar-final-icon' src={communityIcon} alt="icon" />
...
<NavLink style={{textDecoration:"none" }} to="#">
      ...
      <button onClick={user ? () => signOut(auth).then(() => {dispatch(logout());dispatch(remove());dispatch(removeUserDoc());dispatch(removeUserFundingDoc())})
              ...
              : () => navigate("/login")
          } className='sidebar-final-logout-btn'><img className='sidebar-final-icon-logout' src={logOut} alt="icon" />Log Out</button>
