  ...
  const CourseData = [
    {
      ...
      desc: "Is it worth while to pursue your fresh startup idea? Let's put it through our tried-and-true method to obtain opinions from experts, users ............",
    },
    {
      id: 2,
      ...
      url: "/idea-validation",
      desc: "How are businesses supported in reality? From the various funding sources accessible to locating investors and creating the ideal pitch.........",
    },
    {
      id: 3,
      ...
      desc: "Find out who angel investors are, why they invest in early-stage firms, and how to contact them. Discover how to use your connections ........",
    },
  ];
        ...
        <section id="dashboard-data-cont">
          <div className="dashboard-data-left-cont">
            ...
            <section className="mentors-containerr">
              <div className="mentor_container_heading">
                <div className="mentor_heading_text">
                  <h2 className="mentors-container-titlee">Book a Mentor</h2>
                  <p>
                    Review , ask for help for your pitch with founders,
                    investors etc.
                  </p>
                </div>
                <button
