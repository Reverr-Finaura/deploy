...
import { dropinComponents } from '../../components/Cashfree Dropin Container/DropInComments';
...
function Rs501Payment({sessionIdTokken,mentorDetails,setSessionIdTokken,userDoc,setPaymentModeOn,setPaymentMade}) {
