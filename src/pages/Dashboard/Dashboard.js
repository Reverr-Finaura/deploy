...
<div className="user-container">
  <div >
  <h1 className="greeting">Welcome <span><h4 className="userName">{userName}</h4></span> !</h1>
  <img className="handwave-img" src="./images/welcomeImg.png" alt="handwave" />
  </div>
...
<section id="quotation-cont">
  ...
  <img className="quotation-cont_faltuIcon1" src="/images/faltuIcon1.png" alt="" />
...
<img className="quotation-cont_faltuIcon2" src="/images/faltuIcon2.png" alt="" />
  </div>
</section>
...
<img className="blog-containerr_faltuIcon3" src="/images/faltuIcon3.png" alt="" />
<div className="blog-containerr_Top">
<h4 style={{marginBottom:"1rem"}} className="course-container-heading">Blogs</h4>
<button onClick={() =>window.open("https://reverr.io/blog", "_blank")}  className="blog-containerr_Top_loadMoreBtn">Load More</button>
</div>
  {blogArray.slice(0,3).map((item,index)=>{
    return <BlogCard item={item} key={index} />
  })}
  <img className="blog-containerr_faltuIcon4" src="/images/faltuIcon4.png" alt="" />
</section>
